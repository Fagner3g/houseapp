...
export const DEFAULT_CATEGORIES: DefaultCategory[] = [
  ...
  { name: 'Saúde & Beleza', type: 'expense', color: '#EC4899' },
...
const DEPRECATED_CATEGORY_MIGRATIONS: Array<{
  ...
  { from: 'Saúde', to: 'Saúde & Beleza', type: 'expense' },
  { from: 'Saúde & Bem-estar', to: 'Saúde & Beleza', type: 'expense' },
  ...
  { from: 'Saúde, Farmácia & Bem-estar', to: 'Saúde & Beleza', type: 'expense' },
