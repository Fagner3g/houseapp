...
// Debug: logar todas as variáveis VITE_ disponíveis
console.log('[ENV DEBUG] VITE_API_HOST:', import.meta.env.VITE_API_HOST)
console.log('[ENV DEBUG] VITE_OPENAPI_URL:', import.meta.env.VITE_OPENAPI_URL)
console.log('[ENV DEBUG] KUBB_LOG_LEVEL:', import.meta.env.KUBB_LOG_LEVEL)
