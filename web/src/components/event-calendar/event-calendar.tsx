...
export function EventCalendar({
  ...
  return (
    <div
      className={cn('flex flex-col rounded-lg border has-data-[slot=month-view]:flex-1', className)}
      style={
        {
    ...
    >
      <CalendarDndProvider onEventUpdate={handleEventUpdate}>
        <div className="flex flex-col gap-2 p-2 sm:flex-row sm:items-center sm:justify-between sm:p-4">
          {/* Primeira linha em mobile: Navegação e título */}
          ...
          {/* Segunda linha em mobile: Controles de visualização */}
