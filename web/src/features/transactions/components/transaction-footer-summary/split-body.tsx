...
/** Expanded extras only — Meu valor / Compra total primary lives in the header. */
export function SplitSummaryBody({
  ...
  const showPurchaseTotal = showMyShare
  const hasMetricGrid = showPurchaseTotal || installmentMetric != null
      ...
      {hasMetricGrid ? (
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
          {showPurchaseTotal ? (
            <SummaryMetric
              label={
                splitDebtSummary.purchaseTotalIsEstimate
